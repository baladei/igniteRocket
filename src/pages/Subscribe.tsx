...
export function Subscribe () {
    ...
    async function handleSubscribe (event: FormEvent) {
        event.preventDefault(); //esquema para não levar o usuario para outra pagina, manter a pagina apos o SUBMIT
    ...
    return (
        <div className="min-h-screen bg-home bg-cover bg-no-repeat flex flex-col items-center">
            ...
            <img src="/src/assets/Vsbackground.png" className="mt-10 w-full max-w-[1100px] max-h-[500px] opacity-50" alt="" />
        </div>
    );
}